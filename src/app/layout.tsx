...
export const metadata: Metadata = {
  title: "Agentic MVPs - Build AI Apps in Days",
  description: "Deploy AI-powered MVPs lightning fast. Build production-ready intelligent agents without infrastructure complexity.",
  keywords: "AI MVP, artificial intelligence, agent development, no-code AI, AI platform",
  metadataBase: new URL("https://agentic-mvps.com"),
  alternates: {
    canonical: "https://agentic-mvps.com"
  },
  openGraph: {
    title: "Agentic MVPs - AI Development Made Simple",
    description: "Deploy AI-powered MVPs 10x faster. No infrastructure complexity, just pure innovation.",
    url: "https://agentic-mvps.com",
    siteName: "Agentic MVPs",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1764020023768-rwovg5uv.jpg",
        alt: "Agentic MVPs AI Platform"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Agentic MVPs - Build AI Apps in Days",
    description: "Deploy AI-powered MVPs 10x faster with intelligent agents",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1764020024730-v1n1ci43.jpg"]
  },
  robots: {
    index: true,
    follow: true
